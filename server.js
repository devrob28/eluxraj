...
const oracleRoutes = require('./routes/oracle');const fidelityRoutes = require('./routes/fidelity');
...
app.use("/api/oracle", oracleRoutes);app.use('/api/fidelity', fidelityRoutes);
